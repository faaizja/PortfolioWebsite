...
const Footer = () => {
  return (
    <section id="Connect" className="lg:px-24 px-6 lg:mt-20 mt-10 bg-black h-56">
      ...
      {/* buttons div */}
      <div className="flex gap-3 lg:mt-1 mt-6 lg:gap-5 lg:pt-8">
        ...
        <button
          ...
          className="flex bg-black text-white border-2 border-gray-700 rounded-full lg:px-40 lg:py-2 py-2 px-5 font-semibold font-interTight lg:text-xl text-[0.75rem] hover:bg-gray-600 ease-in-out duration-500"
        >
          LinkedIn
          <FiArrowUpRight strokeWidth={3} size={20} className="scale-75 ml-2 text-white transform transition-transform ease-in-out duration-500" />
        </button>
        ...
        <button
          ...
          className="flex bg-black text-white border-2 border-gray-700 rounded-full lg:px-44 lg:py-2 py-2 px-5 font-semibold font-interTight lg:text-xl text-[0.75rem] hover:bg-gray-600 ease-in-out duration-500"
        >
          GitHub
          <FiArrowUpRight strokeWidth={3} size={20} className="scale-75 ml-2 text-white transform transition-transform ease-in-out duration-500" />
        </button>
        ...
        <button
          ...
          className="flex bg-black text-white border-2 border-gray-700 rounded-full lg:px-44 lg:py-2 py-2 px-6 font-semibold font-interTight lg:text-xl text-[0.75rem] hover:bg-gray-600 ease-in-out duration-500"
        >
            Email
            <FiArrowUpRight strokeWidth={3} size={20} className="scale-75 ml-2 text-white transform transition-transform ease-in-out duration-500" />
        </button>
